        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { icon: Brain, title: "ML Integration", desc: "AI-powered solutions & intelligent systems", link: "/services/ml-integration", color: "from-blue-500 to-indigo-500" },
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              >
                ...
                <div className="text-4xl font-bold bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent">{stat.value}</div>
