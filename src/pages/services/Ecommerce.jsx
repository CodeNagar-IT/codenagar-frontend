      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-blue-500/10 rounded-full px-4 py-2 mb-4">
            ...
            <span className="text-blue-300 text-sm">Sell Online with Ease</span>
          </div>
          <h1 className="text-5xl md:text-6xl font-bold mb-4">
            E-commerce <span className="bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent">Development</span>
          </h1>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                { icon: Globe, name: "WooCommerce", color: "from-blue-500 to-indigo-500", desc: "WordPress based" },
        ...
        >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: Users, title: "Customer Accounts", desc: "Order history & wishlists", color: "from-indigo-500 to-rose-500" },
            ].map((feature, idx) => (
              <motion.div 
                key={idx} 
                whileHover={{ y: -5 }}
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-blue-400" /> SEO-optimized product pages</div>
                  <div className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-blue-400" /> Social media integration</div>
                  <div className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-blue-400" /> Email marketing automation</div>
                  <div className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-blue-400" /> Abandoned cart recovery</div>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-gray-800/50 rounded-xl p-4 text-center">
                  <FaInstagram className="w-6 h-6 mx-auto mb-2 text-blue-400" />
                  <p className="text-xs text-gray-400">Instagram Shopping</p>
                </div>
                <div className="bg-gray-800/50 rounded-xl p-4 text-center">
                  <FaFacebook className="w-6 h-6 mx-auto mb-2 text-blue-400" />
                ...
                <div className="bg-gray-800/50 rounded-xl p-4 text-center">
                  <FaTwitter className="w-6 h-6 mx-auto mb-2 text-blue-400" />
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              { name: "Professional", price: "$399", priceLabel: "one-time", features: ["Up to 1000 Products", "Advanced SEO", "Email Marketing", "Abandoned Cart", "Inventory Management", "3 Months Support"], popular: true, color: "from-blue-500 to-indigo-500" },
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="text-blue-400 font-bold text-xl">50K+</div>
