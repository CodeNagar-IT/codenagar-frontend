      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-blue-500/10 rounded-full px-4 py-2 mb-4">
            ...
            <span className="text-blue-300 text-sm">Creative Design Solutions</span>
          </div>
          <h1 className="text-5xl md:text-6xl font-bold mb-4">
            UI/UX <span className="bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent">Design</span>
          </h1>
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-20">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                { icon: SiFigma, name: "Figma", color: "from-blue-500 to-indigo-500" },
        ...
        >
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-blue-500/10 rounded-full px-3 py-1 mb-4">
              ...
              <span className="text-blue-300 text-xs">What We Offer</span>
            </div>
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              { name: "Professional", price: "$159", priceLabel: "project", features: ["15 Screens", "High-fidelity Design", "Interactive Prototype", "Design System", "User Testing"], popular: true, color: "from-blue-500 to-indigo-500" },
