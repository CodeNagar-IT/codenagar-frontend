      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-purple-500/10 rounded-full px-4 py-2 mb-4">
            ...
            <span className="text-purple-300 text-sm">Automate • Deploy • Scale</span>
          </div>
          <h1 className="text-5xl md:text-6xl font-bold mb-4">
            DevOps <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">Services</span>
          </h1>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: Cloud, title: "Cloud Infrastructure", desc: "AWS, Azure, GCP setup & management", color: "from-purple-500 to-pink-500" },
              ...
              { icon: RefreshCw, title: "Disaster Recovery", desc: "Backup & recovery solutions", color: "from-indigo-500 to-purple-500" },
            ].map((service, idx) => (
              <motion.div 
                key={idx} 
                whileHover={{ y: -5 }}
        ...
        >
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-purple-500/10 rounded-full px-3 py-1 mb-4">
              ...
              <span className="text-purple-300 text-xs">Our Pipeline</span>
            </div>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { icon: Clock, title: "Reduced Lead Time", desc: "Hours vs days/weeks", color: "from-purple-500 to-pink-500" },
            ].map((benefit, idx) => (
              <motion.div 
                key={idx} 
                whileHover={{ y: -5 }}
        ...
        >
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-purple-500/10 rounded-full px-3 py-1 mb-4">
              ...
              <span className="text-purple-300 text-xs">Cloud Partners</span>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              >
                <provider.icon className="w-10 h-10 mx-auto mb-2 text-purple-400" />
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <div className="flex items-center gap-4">
                  <div>
                    <div className="text-purple-400 font-bold text-xl">4hrs → 15min</div>
