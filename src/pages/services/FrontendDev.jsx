...
import { 
  CheckCircle, Code, Layout, Smartphone, Globe, Zap, Shield, Eye, 
  Sparkles, ArrowRight, Clock, Award, Users, TrendingUp, DollarSign, 
  Heart, Monitor, Palette, Briefcase, Star
} from "lucide-react";
...
export default function FrontendDev() {
  ...
  const prices = {
    basic: { usd: 799, pkr: 223000 },
    professional: { usd: 1499, pkr: 419000 },
  ...
  useEffect(() => {
    const fetchPortfolioItems = async () => {
      try {
        ...
        // Filter for Web/Frontend related projects
        const frontendProjects = response.data.filter(item => 
          item.category === "Web Development" || 
          (item.title && (item.title.toLowerCase().includes("website") || 
                         item.title.toLowerCase().includes("frontend") ||
                         item.title.toLowerCase().includes("ui")))
        );
        setPortfolioItems(frontendProjects.slice(0, 3));
      } catch (error) {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-cyan-500/10 rounded-full px-4 py-2 mb-4">
            ...
            <span className="text-cyan-300 text-sm">Modern Frontend Solutions</span>
          </div>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                { icon: Eye, name: "Redux/Context", color: "from-purple-500 to-pink-500" },
              ].map((tech, idx) => (
                <motion.div 
                  key={idx} 
        ...
        >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: Monitor, title: "Custom Websites", desc: "Unique, brand-aligned websites", color: "from-cyan-500 to-blue-500" },
        ...
        >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: Users, title: "Better Engagement", desc: "40% lower bounce rate", color: "from-cyan-500 to-blue-500" },
        ...
        >
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-cyan-500/10 rounded-full px-3 py-1 mb-4">
              ...
              <span className="text-cyan-300 text-xs">Frameworks</span>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              >
                <framework.icon className="w-8 h-8 mx-auto mb-2 text-cyan-400" />
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <ul className="space-y-3 mb-8">
                {["Up to 5 Pages", "Responsive Design", "Basic Animations", "Contact Form", "1 Month Support"].map((feature, i) => (
              ...
              <Link 
                to="/services/frontend-development/inquiry"
            ...
            >
              ...
              <ul className="space-y-3 mb-8">
                {["Up to 15 Pages", "Advanced Animations", "SEO Optimization", "Performance Tuning", "API Integration", "3 Months Support"].map((feature, i) => (
                  <li key={i} className="flex items-center gap-2 text-sm">
                    <CheckCircle className="w-4 h-4 text-cyan-400 flex-shrink-0" />
                    <span className="text-gray-300">{feature}</span>
                  </li>
            ...
            >
              ...
              <ul className="space-y-3 mb-8">
                {["Unlimited Pages", "PWA Development", "Custom Components", "Dedicated Developer", "24/7 Support", "SLA Agreement"].map((feature, i) => (
                  <li key={i} className="flex items-center gap-2 text-sm">
                    <CheckCircle className="w-4 h-4 text-cyan-400 flex-shrink-0" />
                    <span className="text-gray-300">{feature}</span>
                  </li>
        ...
        >
          ...
          {loadingPortfolio ? (
            ...
            <div className="text-center py-12 glass-card">
              ...
              <p className="text-gray-400">No frontend projects found in portfolio.</p>
