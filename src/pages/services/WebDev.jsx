      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-blue-500/10 rounded-full px-4 py-2 mb-4">
            ...
            <span className="text-blue-300 text-sm">Expert Web Solutions</span>
          </div>
          <h1 className="text-5xl md:text-6xl font-bold mb-4">
            Web <span className="bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent">Development</span>
          </h1>
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              { name: "Professional", price: "$349", priceLabel: "one-time", features: ["15 Pages", "CMS Integration", "E-commerce Ready", "Advanced SEO", "Speed Optimization"], popular: true, color: "from-blue-500 to-indigo-500" },
