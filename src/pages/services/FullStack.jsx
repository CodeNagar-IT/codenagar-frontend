      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-blue-500/10 rounded-full px-4 py-2 mb-4">
            ...
            <span className="text-blue-300 text-sm">End-to-End Development</span>
          </div>
          <h1 className="text-5xl md:text-6xl font-bold mb-4">
            Full Stack <span className="bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent">Development</span>
          </h1>
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              { name: "Business", price: "$499", priceLabel: "project", features: ["Up to 30 Pages", "Advanced Features", "Payment Integration", "Admin Dashboard", "API Development", "3 Months Support"], popular: true, color: "from-blue-500 to-indigo-500" },
        ...
        >
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-blue-500/10 rounded-full px-3 py-1 mb-4">
              ...
              <span className="text-blue-300 text-xs">Technologies</span>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              >
                <stack.icon className="w-8 h-8 mx-auto mb-2 text-blue-400" />
