...
const Courses = () => {
  ...
  const getBadgeColor = (badge) => {
    switch(badge) {
      ...
      case "AI Powered": return "bg-purple-500";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-purple-500/10 rounded-full px-4 py-2 mb-4">
            ...
            <span className="text-purple-300 text-sm">Learn & Grow</span>
          </div>
          <h1 className="text-5xl md:text-6xl font-bold mb-4">
            Our <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">Courses</span>
          </h1>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {courses.map((course, idx) => (
            <motion.div
              ...
              whileHover={{ y: -8 }}
              className="group bg-gray-800/50 backdrop-blur-sm rounded-xl overflow-hidden border border-gray-700 hover:border-purple-500 transition-all duration-300 relative"
            >
              {/* Badge */}
              {course.badge && (
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-3 mb-4 text-sm text-gray-400">
                  <span className="flex items-center gap-1"><Clock className="w-4 h-4 text-purple-400" /> {course.duration}</span>
                  <span className="flex items-center gap-1"><Users className="w-4 h-4 text-purple-400" /> {course.students}+</span>
                  <span className="flex items-center gap-1"><Award className="w-4 h-4 text-purple-400" /> {course.level}</span>
                </div>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <Link 
                    ...
                    className="flex items-center gap-1 text-purple-400 hover:text-purple-300 group-hover:gap-2 transition-all"
                  >
        ...
        >
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 flex items-center justify-center gap-2">
              ...
              Why Choose <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">CodeNagar</span> for Training?
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { icon: Headphones, value: "24/7", label: "Support", desc: "Dedicated mentors", color: "from-purple-500 to-pink-500" },
              { icon: Award, value: "Certified", label: "Trainers", desc: "Industry experts", color: "from-orange-500 to-red-500" },
            ].map((stat, idx) => (
              <motion.div 
                key={idx}
                whileHover={{ y: -5 }}
                className="text-center p-6 bg-gray-800/30 rounded-xl border border-gray-700 hover:border-purple-500 transition-all group"
              >
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2"><CheckCircle className="w-5 h-5 text-purple-400" /> Industry-recognized certification</div>
                  <div className="flex items-center gap-2"><CheckCircle className="w-5 h-5 text-purple-400" /> Hands-on project experience</div>
                  <div className="flex items-center gap-2"><CheckCircle className="w-5 h-5 text-purple-400" /> 1-on-1 mentorship sessions</div>
                  <div className="flex items-center gap-2"><CheckCircle className="w-5 h-5 text-purple-400" /> Lifetime access to course materials</div>
                  <div className="flex items-center gap-2"><CheckCircle className="w-5 h-5 text-purple-400" /> Resume & interview preparation</div>
                </div>
              </div>
        ...
        >
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold mb-4">Our <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">Success</span> in Numbers</h2>
