    ...
    <div className="min-h-screen flex items-center justify-center pt-20 px-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl mb-4 mx-auto shadow-lg">
          ...
          <p className="text-gray-400">Sign in to your <span className="text-purple-400">CodeNagar</span> account</p>
        </div>
