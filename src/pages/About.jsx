      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-purple-500/10 rounded-full px-4 py-2 mb-4">
            ...
            <span className="text-purple-300 text-sm">Who We Are</span>
          </div>
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            About <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">CodeNagar</span>
          </h1>
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-20">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-purple-500/10 rounded-full px-3 py-1 mb-4">
              ...
              <span className="text-purple-300 text-xs">Our Journey</span>
            </div>
            ...
            <p className="text-gray-300 mb-4 leading-relaxed">
              Today, we've successfully delivered <span className="text-purple-400 font-semibold">50+ projects</span>, trained <span className="text-purple-400 font-semibold">200+ students</span>, and built lasting relationships with <span className="text-purple-400 font-semibold">100+ satisfied clients</span> across Pakistan and beyond.
            </p>
        ...
        >
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-purple-500/10 rounded-full px-3 py-1 mb-4">
              ...
              <span className="text-purple-300 text-xs">What Drives Us</span>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: Heart, title: "Integrity", desc: "Honest communication and transparent processes", color: "from-red-500 to-pink-500" },
              { icon: Users, title: "Collaboration", desc: "Working together to achieve remarkable results", color: "from-green-500 to-emerald-500" },
              { icon: Award, title: "Innovation", desc: "Staying ahead with cutting-edge technologies", color: "from-purple-500 to-pink-500" },
              { icon: Clock, title: "Reliability", desc: "Delivering on time, every time", color: "from-orange-500 to-red-500" },
              { icon: Globe, title: "Community", desc: "Giving back to the tech ecosystem", color: "from-indigo-500 to-purple-500" },
            ].map((value, idx) => (
              <motion.div 
                key={idx} 
        ...
        >
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-purple-500/10 rounded-full px-3 py-1 mb-4">
              ...
              <span className="text-purple-300 text-xs">Our People</span>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { name: "Ali Raza", role: "CEO & Founder", image: "https://randomuser.me/api/portraits/men/1.jpg", bio: "10+ years in software development" },
              { name: "Sara Khan", role: "CTO", image: "https://randomuser.me/api/portraits/women/2.jpg", bio: "Ex-Google, AI specialist" },
              { name: "Usman Ahmed", role: "Head of Training", image: "https://randomuser.me/api/portraits/men/3.jpg", bio: "Certified instructor, 500+ students trained" },
            ].map((member, idx) => (
              <motion.div 
                key={idx} 
                whileHover={{ y: -8 }}
                className="group text-center bg-gray-800/30 rounded-2xl p-6 border border-gray-700 hover:border-purple-500 transition-all duration-300"
              >
                <div className="relative inline-block">
                  <img 
                    src={member.image} 
                    alt={member.name} 
                    className="w-32 h-32 rounded-full mx-auto mb-4 object-cover border-4 border-purple-500 group-hover:border-purple-400 transition-all" 
                  />
                  <div className="absolute inset-0 rounded-full bg-gradient-to-r from-purple-500/20 to-pink-500/20 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                </div>
